...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		fill(color(255, 0, 0));
		triangle(50, (125-7), (50+7/2), (125+7/2), (50-7/2),  (125+7/2));
...
*/		
		fill(0, 0, 0);
		text("City Marker", 75, 123);
		text("4.0+ Magnitude", 75, 173);
	...
	private void printQuakes() 
	{
		...
		for (Marker cm : countryMarkers) { 
			...
			for (Marker qm: quakeMarkers) {
				...
				if(em.isOnLand()) {
					if(country.equals((String)cm.getProperty("name"))) {
						quakeCounter++;
					}
				}
				else {
		...
		System.out.println("Ocean Count: "+oceanCounter);
	}
